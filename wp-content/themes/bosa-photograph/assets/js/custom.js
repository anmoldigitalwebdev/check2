...
*/
function bosa_photograph_slickNavHeight (){
...
*/
function bosa_photograph_wpMenuAccordion( selector ){
...
function bosa_photograph_fixed_header(){
  $notificationHight = $( '.notification-bar' ).height();
  $logo_selector = document.getElementById( 'headerLogo' );
  var width = $( window ).width();

  if ( $logo_selector && BOSAPHOTOGRAPH.fixed_nav && BOSAPHOTOGRAPH.fixed_header_logo ) { 
    if ( $mastheadHeight < $(window).scrollTop()){
      if ( BOSAPHOTOGRAPH.separate_logo == '' ){
        if ( BOSAPHOTOGRAPH.the_custom_logo !== '' ){
          $logo_selector.src = BOSAPHOTOGRAPH.the_custom_logo;
        }
      }else{
        $( '.site-header .site-branding img' ).css( 'display' , 'block' );
        if( !BOSAPHOTOGRAPH.mobile_fixed_nav_off || width >= 782 ){
          $logo_selector.src = BOSAPHOTOGRAPH.separate_logo;
        }
      }
    }else{
      if ( BOSAPHOTOGRAPH.header_two_logo !== '' && ( BOSAPHOTOGRAPH.is_front_page || BOSAPHOTOGRAPH.overlay_post || BOSAPHOTOGRAPH.overlay_page ) && BOSAPHOTOGRAPH.is_header_two ){
         $logo_selector.src = BOSAPHOTOGRAPH.header_two_logo;
      }else if ( BOSAPHOTOGRAPH.the_custom_logo !== '' ) {
          $logo_selector.src = BOSAPHOTOGRAPH.the_custom_logo;
      }else if ( BOSAPHOTOGRAPH.separate_logo !== '' ){
        $( '.site-header .site-branding img' ).css( 'display' , 'none' );
      }
    }
  }
  if ( $mastheadHeight > $( window ).scrollTop() || $( window ).scrollTop() == 0 ) {
      if ( BOSAPHOTOGRAPH.fixed_nav && $( '#masthead.site-header' ).hasClass( 'sticky-header' )){
          $( '#masthead.site-header' ).removeClass( 'sticky-header' );
          // Fixed header in admin bar
          if( BOSAPHOTOGRAPH.is_admin_bar_showing && width >= 782 ){
            $( '.fixed-header' ).css( 'marginTop', 0 );
          }
          if( BOSAPHOTOGRAPH.is_admin_bar_showing && width <= 781 ){
            $( '.fixed-header' ).css( 'marginTop', 0 );
          }
      }
  }else if ( BOSAPHOTOGRAPH.fixed_nav && !$( '#masthead.site-header' ).hasClass( 'sticky-header' )){
    if( !BOSAPHOTOGRAPH.mobile_fixed_nav_off || width >= 782 ){
      ...
      if( BOSAPHOTOGRAPH.is_admin_bar_showing && width <= 600 ){
        $( '.fixed-header' ).css( 'marginTop', 0 );
      }
      if( BOSAPHOTOGRAPH.mobile_fixed_nav_off && width <= 781 ){
        $( '.fixed-header' ).css( 'marginTop', 0 );
    }
  }
}
...
*/
function bosa_photograph_header_two_postion() {
  var width = $( window ).width();

  if ( BOSAPHOTOGRAPH.is_header_two ) {
    if( BOSAPHOTOGRAPH.is_admin_bar_showing && width >= 782 ){
...
jQuery( document ).ready( function() {
  bosa_photograph_slickNavHeight();
  bosa_photograph_wpMenuAccordion( '#offcanvas-menu' );
  bosa_photograph_header_two_postion();
  ...
  */
  $( '.header-image-slider' ).slick({
      ...
      fade: BOSAPHOTOGRAPH.header_image_slider.fade,
      speed: parseInt( BOSAPHOTOGRAPH.header_image_slider.fadeControl ),
      cssEase: 'linear',
      autoplay: BOSAPHOTOGRAPH.header_image_slider.autoplay,
      autoplaySpeed: BOSAPHOTOGRAPH.header_image_slider.autoplaySpeed,
      infinite: true,
  ...
  */
  $( '#primary-menu' ).slicknav({
      ...
      label: BOSAPHOTOGRAPH.responsive_header_menu_text,
  ...
  */
  $( '.main-slider' ).slick({
      ...
      arrows: true,
      adaptiveHeight: false,
      fade: BOSAPHOTOGRAPH.main_slider.fade,
      speed: parseInt( BOSAPHOTOGRAPH.main_slider.fadeControl ),
      cssEase: 'linear',
      autoplay: BOSAPHOTOGRAPH.main_slider.autoplay,
      autoplaySpeed: BOSAPHOTOGRAPH.main_slider.autoplaySpeed,
      infinite: true,
  ...
  $( '.highlight-post-slider' ).slick({
      arrows: true,
      dots: true,
      slidesToShow: BOSAPHOTOGRAPH.home_highlight_posts.slidesToShow,
      slidesToScroll: 1,
      adaptiveHeight: false,
      autoplay: BOSAPHOTOGRAPH.home_highlight_posts.autoplay,
      autoplaySpeed: BOSAPHOTOGRAPH.home_highlight_posts.autoplaySpeed,
      infinite: false,
      rows: 0,
  ...
  * Sticky sidebar
  */
  if( BOSAPHOTOGRAPH.sticky_sidebar ){
...
jQuery( window ).on( 'load', function(){
  ...
  * Back to top
  */
  if( BOSAPHOTOGRAPH.enable_scroll_top == true && $(window).scrollTop() > 200 ){
...
jQuery( window ).on( 'scroll', function(){
  ...
  * Back to top
  */
  if( BOSAPHOTOGRAPH.disable_scroll_top == false && $(window).scrollTop() > 200 ){
    $( '#back-to-top' ).fadeIn( 200 );
  } else{
    $( '#back-to-top' ).fadeOut( 200 );
  }
